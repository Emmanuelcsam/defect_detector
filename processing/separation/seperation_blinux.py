...
class FiberOpticAnalyzer:
    ...
    def _extract_edge_points(self):
        ...
        # Use skimage morphology thinning instead of cv2.ximgproc
        from skimage.morphology import thin
        thinned_edges = thin(combined_edges > 0).astype(np.uint8) * 255
    ...
    def display_visualizations(self):
        ...
        print("Skipping display due to GUI constraints.")
        # Comment out the display code
        # for name, fig in self.visualizations:
        #     plt.show()
...
if __name__ == "__main__":
    ...
    analyzer = FiberOpticAnalyzer('/home/jarvis/Downloads/gpt.png')
