...
class UltraComprehensiveMatrixAnalyzer:
    ...
    def extract_ultra_comprehensive_features(self, image):
        ...
        # Sanitize all feature values to ensure they are finite
        sanitized_features = {}
    ...
    def build_comprehensive_reference_model(self, ref_dir):
        ...
        if len(scores_array) > 0 and not np.all(np.isnan(scores_array)):
            ...
            valid_scores = valid_scores[np.isfinite(valid_scores)]  # Remove inf values
            ...
            if len(valid_scores) > 0:
                ...
                # Ensure reasonable bounds for threshold
                thresholds = {
    ...
    def detect_anomalies_comprehensive(self, test_path):
        ...
        try:
            ...
            # Fallback to normalized Euclidean distance if Mahalanobis fails
        ...
        # Ensure numpy array (in case loaded from JSON)
